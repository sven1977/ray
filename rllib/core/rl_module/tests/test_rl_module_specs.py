...
class TestRLModuleSpecs(unittest.TestCase):
    ...
    def test_update_specs(self):
        ...
        module_spec_2 = RLModuleSpec(model_config={"fcnet_hiddens": [32]})
        self.assertEqual(module_spec_1.model_config, "Update me!")
        module_spec_1.update(module_spec_2)
        self.assertEqual(module_spec_1.model_config, {"fcnet_hiddens": [32]})
    ...
    def test_update_specs_multi_agent(self):
        ...
        self.assertEqual(
            marl_spec_1.module_specs["agent_1"].model_config, "Update me!"
        )
        ...
        self.assertEqual(
            marl_spec_1.module_specs["agent_2"].model_config, "I'm new!"
        )
